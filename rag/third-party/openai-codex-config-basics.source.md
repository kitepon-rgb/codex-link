<!--
source_id: openai-codex-config-basics
source_url: https://developers.openai.com/codex/config-basic
reader: jina
reader_url: https://r.jina.ai/https://developers.openai.com/codex/config-basic
fetched_at: 2026-05-10T07:47:40.628Z
-->
...
On managed machines, your organization may also enforce constraints via `requirements.toml` (for example, disallowing `approval_policy = "never"` or `sandbox_mode = "danger-full-access"`). See [Managed configuration](https://developers.openai.com/codex/enterprise/managed-configuration) and [Admin-enforced requirements](https://developers.openai.com/codex/enterprise/managed-configuration#admin-enforced-requirements-requirementstoml).
